        ...
        GestureDetector(
          ...
          child: Container(
            padding:EdgeInsets.symmetric(horizontal:25,vertical:10),
              child: Row(children: [
            Text('Back to Home Page', style: TextStyle(color: white)),
            Icon(Icons.keyboard_double_arrow_left_rounded, color: white)
          ])),
        ),
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    shape: BoxShape.circle, color: custom_colors.accentOrange),
              ),
              Text(
                'Rex Lim',
                style: TextStyle(
